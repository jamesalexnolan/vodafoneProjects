        ...
        if (vt654_target) {
            ...
            for (var i = 0; i < vt654_headers.length; i++) {
                if (!vt654_headers[i].parentElement.parentElement.querySelector('[title*="completed"]')) {
                    vt654_headers[i].style.color = 'grey'
                } else {
